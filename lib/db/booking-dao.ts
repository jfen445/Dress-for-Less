...
export async function getBookingsByPaymentIntent(paymentIntent: String) {
  return BookingSchema.find(
    ...
    "dressId userId address billingAddress blockOutPeriod createdAt dateBooked deliveryType isReturned isShipped price paymentIntent paymentSuccess tracking size"
  );
}
