...
const initialTabList = [
  ...
  { name: AdminTabs.BlockOuts, href: "#", icon: NoSymbolIcon, current: false },
  { name: AdminTabs.TryOns, href: "#", icon: CalendarIcon, current: false },
  { name: AdminTabs.Coupons, href: "#", icon: TicketIcon, current: false },
];
