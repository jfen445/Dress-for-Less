...
const defaultFilters = [
  {
    ...
    options: [
      ...
      { value: "day_events", label: "Day Events ☀️", checked: false },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "multicolour", label: "Multicolour 🏳️‍🌈", checked: false },
    ],
  },
  {
    id: "sizes",
